...
async def login(payload: LoginRequest, request: Request):
    return await proxy(request, "auth/signin")


# ── EXPENSE ───────────────────────────────────────────

@app.post("/expense/add", tags=["Expense"])
